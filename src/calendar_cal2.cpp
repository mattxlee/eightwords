...
int LunarData[100] = {2635,   333387, 1701,   1748,   267701, 694,    2391,   133423, 1175,   396438, 3402,   3749,
...
std::string days[30] = {"初一", "初二", "初三", "初四", "初五", "初六", "初七", "初八", "初九", "初十",
...
std::tuple<CNChar, CNChar> calcCnMonth(int tian_gan_index_of_year, int year, int month, int day) {
    lunar::Date lunar_date = lunar::GetLunarCalendarMonth(year, month, day);
    int tian_gan_index = ((tian_gan_index_of_year * 2 + lunar_date.month) - 1) % TIAN_GAN.size();
